public class AB_RefTab_WhereNotEquals_RefTab_Txt_Scal_Operator : ABOperator<ABTable<ABRef>>
{
    public AB_RefTab_WhereNotEquals_RefTab_Txt_Scal_Operator()
    {
    ...
    public override ABTable<ABRef> Evaluate(ABContext context)
    {
        ...
        b1 = OperatorHelper.Instance.getScalarParam(context, input3);
