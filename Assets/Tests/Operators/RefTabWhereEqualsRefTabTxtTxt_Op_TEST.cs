...
class RefTabWhereEqualsRefTabTxtTxt_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereEquals_RefTab_Txt_Txt_Operator ope = (AB_RefTab_WhereEquals_RefTab_Txt_Txt_Operator)ABOperatorFactory.CreateOperator(symbol);
