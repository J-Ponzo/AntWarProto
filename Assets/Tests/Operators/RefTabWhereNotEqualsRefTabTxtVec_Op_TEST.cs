...
class RefTabWhereNotEqualsRefTabTxtVec_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereNotEquals_RefTab_Txt_Vec_Operator ope = (AB_RefTab_WhereNotEquals_RefTab_Txt_Vec_Operator)ABOperatorFactory.CreateOperator(symbol);
