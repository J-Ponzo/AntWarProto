...
class RefTabWhereNotEqualsRefTabTxtTxt_Op_TEST : MonoBehaviour{

    [SerializeField]
    private string symbol = "R[]where!=R[]TT";
    [SerializeField]
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereNotEquals_RefTab_Txt_Txt_Operator ope = (AB_RefTab_WhereNotEquals_RefTab_Txt_Txt_Operator)ABOperatorFactory.CreateOperator(symbol);

        ABParam<ABTable<ABRef>> tabRef1 = CreateTabRef(2, 6);
        ABParam<ABText> arg2 = ABParamFactory.CreateTextParam("const", r2);
        ABParam<ABText> arg3 = ABParamFactory.CreateTextParam("const", r3);
