...
class RefTabWhereNotEqualsRefTabTxtColor_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereNotEquals_RefTab_Txt_Color_Operator ope = (AB_RefTab_WhereNotEquals_RefTab_Txt_Color_Operator)ABOperatorFactory.CreateOperator(symbol);
