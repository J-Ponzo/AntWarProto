...
class RefTabWhereNotEqualsRefTabTxtBool_Op_TEST : MonoBehaviour {
    ...
    private void RandomizeTest() {
        ...
        AB_RefTab_WhereNotEquals_RefTab_Txt_Bool_Operator ope = (AB_RefTab_WhereNotEquals_RefTab_Txt_Bool_Operator)ABOperatorFactory.CreateOperator(symbol);
